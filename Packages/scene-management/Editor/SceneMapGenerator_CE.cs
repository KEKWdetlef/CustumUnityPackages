...
namespace KekwDetlef.SceneManagement.Editor
{
    ...
    public class SceneMapGenerator_CE : UnityEditor.Editor
    {
        ...
        private void CookSceneMap(List<IndexedScene> uiScenes, List<IndexedScene> worldScenes, string directory, ref string guidDirectory)
        {
            ...
            {
                guidDirectory = AssetDatabase.CreateFolder(directory, "SceneManagement");
                Debug.Log("did happen");
            }

            string[] folderNames = { "Editor", "Misc", "SceneChanger" };
            foreach (string folderName in folderNames)
            {
                if (!AssetDatabase.IsValidFolder(directory + "/SceneManagement/" + folderName))
                {
                    AssetDatabase.CreateFolder(directory + "/SceneManagement/", folderName);
                }
            }

            File.Copy("Packages/com.kekw-detlef.scene-management/Templates/_Editor/SimpleSceneChanger_CE.cs.txt", directory + "/SceneManagement/Editor/SimpleSceneChanger_CE.cs", true);
            File.Copy("Packages/com.kekw-detlef.scene-management/Templates/Misc/ESceneType.cs.txt", directory + "/SceneManagement/Misc/ESceneType.cs", true);
            File.Copy("Packages/com.kekw-detlef.scene-management/Templates/Misc/FSceneInfo.cs.txt", directory + "/SceneManagement/Misc/FSceneInfo.cs", true);
            File.Copy("Packages/com.kekw-detlef.scene-management/Templates/Misc/RuntimeSceneContainer.cs.txt", directory + "/SceneManagement/Misc/RuntimeSceneContainer.cs", true);
            // File.Copy("Packages/com.kekw-detlef.scene-management/Templates/Misc/SceneMap.cs.txt", directory + "/SceneManagement/Misc/SceneMap.cs");
            File.Copy("Packages/com.kekw-detlef.scene-management/Templates/SceneChanger/MultipleSceneChanger.cs.txt", directory + "/SceneManagement/SceneChanger/MultipleSceneChanger.cs", true);
            File.Copy("Packages/com.kekw-detlef.scene-management/Templates/SceneChanger/SceneUnloader.cs.txt", directory + "/SceneManagement/SceneChanger/SceneUnloader.cs", true);
            File.Copy("Packages/com.kekw-detlef.scene-management/Templates/SceneChanger/SimpleSceneLoader.cs.txt", directory + "/SceneManagement/SceneChanger/SimpleSceneLoader.cs", true);

            string filePath = directory + "/SceneManagement/Misc/" + sceneMapFileName;
